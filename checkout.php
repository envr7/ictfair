...
<section class="checkout">
   ...
   <form action="" method="post">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>Regency:</span>
            <input type="text" name="street" required placeholder="e.g. Banyuanyar">
         </div>
         <div class="inputBox">
            <span>City :</span>
            <input type="text" name="city" required placeholder="e.g. Surakarta">
         </div>
         <div class="inputBox">
            <span>State :</span>
            <input type="text" name="state" required placeholder="e.g. Central java">
         </div>
         <div class="inputBox">
            <span>Country :</span>
